...
> 🌐 Language / Ngôn ngữ: [English](STAGE2_R10_QUALIFICATION.md) | **Tiếng Việt**

Tài liệu này ghi lại closed production-demo qualification state được dùng làm provenance cho first public package candidate.
...
Hardened runtime identity đã được chứng minh qua `/proc/<pid>/exe` và `/proc/<pid>/maps` trong qualification.
...
Native reranker instruction transport vẫn frozen. Tài liệu publication này không thay đổi production semantics.
